...
for (const marker of [
  ...
  'AI가 제안한 준비물 초안',
  'AI 2차 결과를 선택 유형별 준비물 초안 칸에 채웠습니다',
  '실제 팀원에게 사용할 문장과 행동은 팀장이 수정해 확정하십시오',
  'AI 결과 선택 유형 자동 분리·채우기',
  '자동 분리된 선택 유형별 내용은 초안입니다',
  '각 팀원 이름을 제목으로 쓰고 아래 항목을 반드시 포함해 주세요',
  '우리 팀에 존재하는 유형 2명 선택',
  '6명 유형 카드 보기와 우리 팀 유사 유형 2명 선택',
  '우리 팀에 실제로 존재하거나 비슷한 행동 신호를 보이는 유형 2명',
  '선택한 유형별 신호 분리 정리',
  '선택한 2명에 대해서만 신호를 분리하고 다음 행동을 준비합니다',
  '선택한 2명 유형에 대해 자동 분리·채우기를 완료했습니다',
