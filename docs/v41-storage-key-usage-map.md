...
- Current Step 6 managed-task update head: `5a18883f3c3c99272ba4a8d0e8217a588fbdb9ac`
...
7. `ckd.v41.taskManagement.v10` now carries the pure task-management chain: Step 6 managed task, work output, and work breakdown → Step 7 execution sequence, responsibility, checkpoint, workload adjustment, and instruction draft → Step 8 task boundary, bottleneck response, and escalation criteria.
...
## Step 6 managed-task, work-output, and work-breakdown rule
...
→ Step 6 managed task for the current execution cycle
...
- Do not ask for execution cycle or work output before selecting the managed task.
...
→ Step 6 optional reviewed reference for managed-task/work-output/work-breakdown only
