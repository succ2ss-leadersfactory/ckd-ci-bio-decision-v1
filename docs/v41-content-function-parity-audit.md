...
| Step 2 team signal | `src/journey-v41-app-preview.tsx` | Navigation works | Compare v40 team member data depth and display cues. | Medium |
...
1. Step 4 question refinement: restore prompt examples, review depth, and coach hints.
2. Step 5 market research: restore source/insight/strategy depth.
3. Step 6 performance cascade: restore logic and decision feedback.
4. Step 7~9 task management: restore ERRC/task boundary depth and outputs.
5. Step 10~11 people management: restore people data, 1on1 practice depth, and reflection outputs.
6. Run static smoke and browser QA again.
