...
function ProcessOverview() {
  const items = [
    { title: '1. 전사 전략과제 선정', text: '이번 실습에서 분석할 전사 전략과제를 선택합니다.' },
    { title: '2. 전략과제 관련 정보 수집', text: 'Perplexity로 공개자료를 찾고, 이후 분석에 쓸 출처 URL을 정리합니다.' },
    { title: '3. 추진과제·CSF·KPI 정리', text: 'NotebookLM으로 수집 자료를 근거 기반 추진과제, CSF, KPI 후보로 정리합니다.' },
    { title: '4. 전사 전략과제 추진계획 수립', text: '보고서·슬라이드·인포그래픽 초안으로 정리해 다음 단계에서 활용합니다.' },
  ];
  return <section className="rounded-3xl border border-cyan-100 bg-white p-5 shadow-sm md:p-6">
    <p className="text-xs font-black uppercase tracking-wide text-cyan-700">시장 변화 읽기</p>
    <h2 className="mt-2 text-xl font-black text-slate-950">전사 전략과제를 근거 기반 추진계획으로 바꾸는 단계입니다</h2>
    <p className="mt-3 max-w-5xl text-sm font-bold leading-7 text-slate-600">이번 단계에서는 전사 전략과제를 하나 선택하고, 관련 공개자료를 찾아 핵심성공요인(CSF), KPI, 추진과제 후보를 정리합니다. 마지막에는 이 내용을 보고서·슬라이드·인포그래픽 초안으로 바꿔 이후 팀 기준 만들기 단계에서 활용합니다.</p>
    ...
    <div className="mt-4 rounded-2xl border border-amber-100 bg-amber-50 p-3 text-xs font-bold leading-5 text-amber-900">도구 이름은 하위 기능으로만 사용합니다. 단계의 목적은 Perplexity 사용법이 아니라, 전사 전략과제를 근거 기반으로 해석하고 추진계획으로 정리하는 것입니다.</div>
  </section>;
}
...
export function V41PharmaStrategyResearchLab() {
  ...
  return <section className="space-y-4">
    ...
    <Section title="1단계: 전사 전략과제 선정" description="이번 실습에서 분석할 전사 전략과제를 선택합니다. 선택한 전략과제는 이후 자료 수집, CSF·KPI 정리, 추진계획 수립의 기준이 됩니다.">
      ...
      <div className="rounded-2xl border border-emerald-100 bg-emerald-50 p-3 text-xs font-bold leading-5 text-emerald-950">
        ...
        <p className="mt-1 text-emerald-800">아래 CSF와 KPI는 선택한 전사 전략과제를 이해하기 위한 전사 관점 기준입니다. 다음 단계에서 공개자료를 찾아 근거를 보강합니다.</p>
    ...
    <Section title="2단계: 전략과제 관련 정보 수집" description="선택한 전략과제와 관련된 최신 공개자료를 찾고, 이후 NotebookLM 분석에 사용할 출처 URL과 핵심 내용을 정리합니다. Perplexity와 URL 분리는 이 단계의 하위 기능입니다.">
      <div className="rounded-2xl border border-cyan-100 bg-cyan-50 p-3 text-xs font-bold leading-5 text-cyan-950">Perplexity에는 선택한 전사 전략과제와 관련된 최신 공개자료만 찾게 합니다. 추진과제, CSF, KPI, 추진계획은 다음 단계에서 소스 기반으로 정리합니다.</div>
    ...
    <Section title="3단계: 추진과제·CSF·KPI 정리" description="수집한 공개자료를 바탕으로 전사 전략과제를 실행하기 위한 추진과제, 핵심성공요인(CSF), 측정 가능한 KPI 후보를 정리합니다. AI 결과를 그대로 확정하지 말고, 근거가 있는 항목과 추정이 섞인 항목을 구분하세요.">
      <div className="rounded-2xl border border-emerald-100 bg-emerald-50 p-3 text-xs font-bold leading-5 text-emerald-950">2단계에서 분리한 URL을 NotebookLM 웹 소스로 등록한 뒤, 아래 프롬프트로 전사 추진과제 후보, 추진과제별 CSF, 추진과제별 KPI를 정리합니다.</div>
    ...
    <Section title="4단계: 전사 전략과제 추진계획 수립" description="정리한 추진과제, CSF, KPI를 바탕으로 전사 전략과제 추진계획 초안을 만듭니다. 결과물은 보고서·슬라이드·인포그래픽 형태로 정리할 수 있습니다.">
