...
export const V39_VISIBLE_APP_STEPS: JourneyStep[] = [
  ...
  },
  {
    ...
    title: '고객군별 2주 대응 방향',
    description: '이 단계: 고객군별 대응 강도, 2주 대응 방향, 보완 조건, 8단계로 넘길 1차 팀원 연결 후보를 정리합니다. 가져온 것: 고객 Data 확인 기준입니다. 넘길 것: 팀원별 역할 보완에서 사용할 고객군별 대응 방향과 1차 연결 후보입니다.',
  },
  {
    id: 'member-role',
    title: '팀원별 실행 보완 Map',
    description: '이 단계: 7단계의 고객군별 대응 방향과 1차 연결 후보를 반복 배정하지 않고, 팀원별 역할 미션·지원 포인트·점검 질문·리스크 안전선을 보완합니다. 가져온 것: 고객군 대응 방향과 1차 팀원 연결 후보입니다. 넘길 것: 9단계 실행 대화 Script에 반영할 팀원별 실행 기준입니다.',
  },
  {
    id: 'people-dialogue',
    title: '팀원 온도차와 실행 대화',
    description: '이 단계: 기존 팀원과 MZ·저연차 팀원이 다르게 받아들일 수 있는 지점을 확인하고, 나 때는 말이야식 표현을 지금 필요한 실행 대화로 바꿉니다. 가져온 것: 팀원별 실행 보완 Map입니다. 넘길 것: AI 실행계획 프롬프트에 반영할 실행 대화 Script입니다.',
  },
  {
    id: 'ai-call-plan',
