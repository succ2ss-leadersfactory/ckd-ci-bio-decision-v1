...
export const V39_VISIBLE_APP_STEPS: JourneyStep[] = [
  ...
  },
  {
    ...
    title: '고객군 × 팀원 2주 실행 Map',
    description: '이 단계: 고객군별 2주 대응 방향과 팀원 연결 기준·실제 연결 후보를 함께 정리합니다. 가져온 것: 고객 Data 확인 기준입니다. 넘길 것: 팀원 온도차와 실행 대화에서 사용할 고객군별 실행 배치입니다.',
  },
  {
    id: 'member-role',
    title: '팀원별 실행 보완 Map',
    description: '이 단계: 7단계 고객군 × 팀원 실행 Map을 반복 배정하지 않고, 팀원별 역할 미션·지원 포인트·점검 질문·리스크 안전선을 보완합니다. 가져온 것: 고객군 대응 방향과 팀원 연결 기준입니다. 넘길 것: 9단계 실행 대화 Script에 반영할 팀원별 실행 기준입니다.',
  },
  {
    id: 'people-dialogue',
    title: '팀원 온도차와 실행 대화',
