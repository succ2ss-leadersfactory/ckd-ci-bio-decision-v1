...
function getV39CustomerJudgmentStatus() {
  ...
  const selectedSignalCount = result.selectedCustomerTypeIds.length;
      ...
      <section className="rounded-3xl border border-emerald-100 bg-white p-4 shadow-sm md:p-5">
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <h2 className="mt-1 text-xl font-black text-slate-950">고객 Data에서 볼 신호만 정리하고, 대응은 7단계에서 정합니다</h2>
            <p className="mt-2 max-w-4xl text-sm font-bold leading-6 text-slate-600">
              5단계 기준을 다시 설명하지 않고, 이번 단계에서는 고객 Data에서 확인할 신호·부족 정보·추가 확인 질문만 남깁니다. 고객군별 대응 방향은 다음 7단계에서 정합니다.
            </p>
          </div>
          <div className="grid gap-2 sm:grid-cols-3 lg:w-[34rem]">
            ...
            <div className="rounded-2xl border border-sky-100 bg-sky-50 px-4 py-3">
              ...
              <p className="mt-1 text-sm font-black text-sky-950">{status.selectedSignalCount}개</p>
            </div>
        ...
        <div className="mt-3 grid gap-2 md:grid-cols-4">
          ...
          <div className="rounded-2xl border border-emerald-100 bg-emerald-50 px-4 py-3 text-xs font-bold leading-5 text-emerald-950">
            ...
            <p className="mt-1">고객 Data에서 먼저 볼 신호, 부족 정보, 팀원에게 더 확인할 질문을 정리합니다.</p>
          </div>
          ...
          <div className="rounded-2xl border border-amber-100 bg-amber-50 px-4 py-3 text-xs font-bold leading-5 text-amber-950">
            ...
            <p className="mt-1">확인 신호 1개, 부족 정보 1개, 추가 확인 질문 1개면 충분합니다.</p>
          </div>
        </div>
