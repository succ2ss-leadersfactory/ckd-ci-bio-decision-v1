...
const TEAM_MEMBER_PROFILES: TeamMemberProfile[] = [
  ...
  },
  {
    ...
    label: '문교원 사원',
    role: '저연차 탐색형',
    workStyle: '디지털 도구와 자료 정리는 빠르게 익히지만 실제 고객 대화 경험은 아직 적습니다. 직접 수행보다 관찰과 작은 시도가 필요할 수 있습니다.',
    customerStyle: '자료 준비와 사전 정리는 잘할 수 있으나 고객 앞에서 질문 순서, 표현 안전선, 예상 반응 대응이 흔들릴 수 있습니다.',
    currentSignal: '디지털 활용은 빠르지만 고객 대화 경험이 부족해 동행·관찰 과제가 필요합니다.',
    recentChange: '자료 정리는 빠르지만 실제 방문 전에는 무엇을 말해야 할지 불안해하거나 선배에게 의존할 수 있습니다.',
    strength: '자료 정리, 디지털 도구 활용, 빠른 학습',
    risk: '고객 앞에서 표현 안전선과 질문 순서를 놓칠 수 있음',
    misreadRisk: '팀장이 “요즘 세대라 디지털은 잘하니 알아서 하겠지”라고 보면 현장 대화 불안을 놓칠 수 있습니다. 반대로 “아직 못 맡긴다”고만 보면 성장 기회가 사라집니다.',
    oneOnOneReason: '동행·관찰·소규모 실행을 어떤 순서로 밟을지 함께 정해야 하기 때문입니다.',
