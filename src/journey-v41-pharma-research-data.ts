...
export const PHARMA_RESEARCH_TOPICS: PharmaResearchTopic[] = [
  ...
  },
  {
    ...
    csfs: [
      '제품 가치 재정의: 주력 제품을 계속 선택해야 하는 이유가 고객 관점으로 다시 정리되어 있어야 한다',
      '처방 유지 위험 파악: 처방 감소, 대체 가능성, 고객 이탈 신호를 빨리 볼 수 있어야 한다',
      '경쟁 대응 기준 마련: 경쟁 제품 언급 시 사용할 근거와 표현 기준이 준비되어 있어야 한다',
    ],
    kpis: [
  ...
  },
  {
    ...
    csfs: [
      '고객 데이터 기준 통일: 방문 기록, 고객 반응, 다음 행동을 같은 기준으로 남길 수 있어야 한다',
      '실행 현황 가시화: 방문, 자료 제공, Follow-up 상태가 관리자에게 한눈에 보여야 한다',
      '점검 주기 정착: 실행 지연과 막힌 지점을 정기적으로 확인하는 운영 방식이 있어야 한다',
    ],
    kpis: [
  ...
  },
  {
    ...
    csfs: [
      '문의 대응 기준 마련: 품질·공급 관련 고객 문의에 답하기 전 확인해야 할 기준이 정해져 있어야 한다',
      '내부 확인 흐름 확보: 현장 문의가 품질, 공급, 컴플라이언스 담당 부서로 빠르게 연결되어야 한다',
