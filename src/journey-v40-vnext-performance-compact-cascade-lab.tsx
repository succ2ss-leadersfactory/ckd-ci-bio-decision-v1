...
import { V40_VNEXT_PERFORMANCE_CASCADE_STORAGE_KEY, V40VNextPerformanceStrategyCascadeLab } from './journey-v40-vnext-performance-strategy-cascade-lab';
    ...
    <section className="space-y-4">
      ...
      <section className="rounded-3xl border border-emerald-100 bg-white p-4 shadow-sm md:p-5">
        <div className="rounded-3xl border border-emerald-100 bg-emerald-50 px-4 py-3 text-sm leading-6 text-emerald-950">
          <p className="font-black">우리 조의 2주 성과관리 기준</p>
          <p className="mt-1 text-xs font-bold leading-5">
            기본 운영에서는 6·7단계를 진행하지 않습니다. 대신 5단계에서 정한 팀 전략과제·CSF·KPI를 바탕으로 8단계 업무관리와 13단계 최종 실행 메모로 넘길 최소 기준만 짧게 남깁니다.
          </p>
        </div>
        <div className="mt-4 grid gap-3 md:grid-cols-2">
          <CompactField
            label="이번 2주 동안 먼저 볼 성과 신호"
