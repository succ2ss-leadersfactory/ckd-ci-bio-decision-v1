...
const TEAM_CASCADE_OPTIONS: TeamCascadeOption[] = [
    ...
    teamTasks: [
      {
        ...
        kpis: [
          kpi('핵심 고객 첫 접점 완료율: 정해진 기간 안에 1차 접점이 완료된 핵심 고객 비율(%)', '주 1회', '핵심 고객 리스트와 1차 접점 완료 표시', '팀장/담당자'),
          kpi('고객 질문·우려 기록 건수: 핵심 고객군에서 수집된 질문·우려·관심 반응 건수(건)', '주 1회', '질문·우려·관심으로 구분된 방문 기록', '팀장'),
          kpi('반응 유형 분류율: 고객 반응이 정해진 유형으로 분류된 비율(%)', '2주 1회', '관심·우려·자료 요청·경쟁 언급 분류표', '팀장'),
        ],
      ...
      },
      {
        ...
        kpis: [
          kpi('고객 니즈 기록 건수: 핵심 고객에게서 수집된 미충족 니즈 건수(건)', '주 1회', '고객별 미충족 니즈 메모', '담당자/팀장'),
          kpi('치료제 선택 기준 분류율: 선택 기준이 유형별로 분류된 고객 반응 비율(%)', '2주 1회', '효과·안전성·편의성·순응도 분류표', '팀장'),
          kpi('제품 가치 근거 연결 건수: 고객 니즈와 연결된 근거자료 후보 건수(건)', '2주 1회', '니즈-근거자료 연결 메모', '팀장'),
        ],
      ...
      },
      {
        ...
        kpis: [
          kpi('자료 요청 접수 건수: 핵심 고객으로부터 접수된 자료 요청 건수(건)', '주 1회', '자료 요청 접수 목록', '담당자'),
          kpi('자료 요청 후속 완료율: 예정일 안에 완료된 자료 요청·후속 확인 비율(%)', '주 1회', '요청일·예정일·완료일 기록', '팀장'),
          kpi('미처리 요청 건수: 기한 내 처리되지 않은 자료 요청 건수(건)', '주 1회', '미처리 요청과 지연 사유 목록', '팀장'),
        ],
      ...
      },
      {
        ...
        kpis: [
          kpi('경쟁 제품 언급 기록 건수: 고객 대화에서 확인된 경쟁 제품 언급 건수(건)', '주 1회', '경쟁 제품 언급 메모', '담당자/팀장'),
          kpi('제형·편의성 반응 수집 건수: 경구제·주사제·순응도 관련 반응 건수(건)', '2주 1회', '제형·편의성 관련 고객 반응 목록', '팀장'),
          kpi('위험 표현 수정 건수: 경쟁 비교·과장 표현을 수정한 건수(건)', '수시/주 1회', '수정 전후 표현 예시', '팀장'),
        ],
    ...
    teamTasks: [
      {
        ...
        kpis: [kpi('주요 고객 가치 이유 정리율: 핵심 고객별 제품 사용 이유가 정리된 비율(%)', '2주 1회', '핵심 고객별 제품 사용 이유 1줄 메모'), kpi('가치 흔들림 신호 기록 건수: 제품 선택 이유가 약해진 신호 건수(건)', '주 1회', '가치 흔들림 신호 기록'), kpi('주요 고객 재접점 완료율: 정해진 기간 안에 재접점이 완료된 주요 고객 비율(%)', '주 1회', '재접점 예정일·완료일 기록')],
      ...
      },
      {
        ...
        kpis: [kpi('고객 가치 표현 수집 건수: 고객이 말한 제품 가치 표현 건수(건)', '주 1회', '고객 표현 원문 기록'), kpi('경쟁 질문 분류율: 경쟁 질문이 유형별로 분류된 비율(%)', '2주 1회', '경쟁 질문 유형 분류표'), kpi('메시지 개선 후보 건수: 고객 반응 기반 메시지 개선 후보 건수(건)', '2주 1회', '메시지 개선 후보 메모')],
      ...
      },
      {
        ...
        kpis: [kpi('처방 감소 신호 기록 건수: 처방 감소·대체 가능성으로 기록된 신호 건수(건)', '주 1회', '처방 감소·대체 가능성 신호 기록'), kpi('고위험 고객 재접점 완료율: 우선 고객 중 재접점 완료 비율(%)', '주 1회', '고위험 고객 재접점 완료 목록'), kpi('팀장 지원 요청 건수: 팀장 개입이 필요한 고객 이슈 건수(건)', '주 1회', '지원 필요 고객 이슈 목록')],
      ...
      },
      {
        ...
        kpis: [kpi('경쟁 질문 공유 건수: 경쟁 제품 관련 질문·우려가 팀에 공유된 건수(건)', '주 1회', '경쟁 질문 공유 목록'), kpi('승인자료 기반 대응률: 승인자료 범위 안에서 진행된 대응 비율(%)', '2주 1회', '승인자료 기반 대응 체크'), kpi('반복 질문 대응 기준 작성 건수: 팀 대응 기준으로 정리된 반복 질문 수(건)', '2주 1회', '반복 질문 대응 기준 문서')],
  ...
  },
  {
    ...
    teamTasks: [
      { id: 'pipeline-question', type: '고객 질문 수집형', task: '핵심 파이프라인과 미래 성장 스토리에 대해 고객이 궁금해하는 주제를 수집하고 승인된 범위 안에서 설명 기준을 정리한다.', csfs: ['설명 가능 범위 확인: 고객에게 말할 수 있는 내용과 확인이 필요한 내용이 구분되어야 한다', '고객 관심 주제 수집: 고객이 궁금해하는 연구·바이오 주제가 기록되어야 한다', '승인자료 기반 설명: 허용된 자료와 표현 범위 안에서만 설명해야 한다'], kpis: [kpi('파이프라인 관련 고객 질문 수집 건수: 고객이 물어본 연구·바이오 관련 질문 수(건)', '주 1회', '파이프라인 질문 기록'), kpi('확인 필요 질문 등록 건수: 즉시 답하지 않고 내부 확인으로 넘긴 질문 수(건)', '주 1회', '확인 필요 질문 목록'), kpi('승인자료 기반 설명률: 승인된 자료 범위 안에서 진행된 설명 비율(%)', '2주 1회', '승인자료 사용 체크')], initiatives: ['파이프라인 질문 수집 항목 만들기', '설명 가능/확인 필요/추가 자료 요청으로 질문 분류', '승인자료 기반 설명 문장 정리'] },
      { id: 'message-upgrade', type: '커뮤니케이션 고도화형', task: '고객이 묻는 파이프라인 관심 주제를 분류해 전사 커뮤니케이션 메시지 고도화에 기여한다.', csfs: ['관심 주제 분류: 고객 질문이 연구, 임상, 사업화, 안전성 등으로 나뉘어야 한다', '반복 질문 식별: 반복되는 질문이 확인되어야 한다', '메시지 개선 연결: 고객 질문이 대외 메시지 개선 후보로 연결되어야 한다'], kpis: [kpi('관심 주제 분류율: 고객 질문이 주제별로 분류된 비율(%)', '2주 1회', '관심 주제 분류표'), kpi('반복 질문 식별 건수: 반복적으로 확인된 질문 수(건)', '2주 1회', '반복 질문 리스트'), kpi('메시지 개선 제안 건수: 고객 질문 기반 메시지 개선 제안 수(건)', '월 1회', '메시지 개선 제안 메모')], initiatives: ['고객 관심 주제 월간 요약 공유', '반복 질문 리스트 작성', '커뮤니케이션 개선 메모 작성'] },
      { id: 'compliance-boundary', type: '표현 경계 관리형', task: '설명 가능한 내용과 내부 확인이 필요한 질문을 구분해 허용된 대외 커뮤니케이션 기준을 지킨다.', csfs: ['표현 경계 인식: 허용 표현과 금지 표현이 구분되어야 한다', '내부 확인 루틴: 답변 전 확인이 필요한 질문은 내부로 연결되어야 한다', '위험 표현 수정: 허가 전·과장 표현을 줄여야 한다'], kpis: [kpi('확인 필요 질문 등록 건수: 내부 확인으로 넘긴 질문 수(건)', '주 1회', '내부 확인 질문 목록'), kpi('위험 표현 수정 건수: 허가 전·과장 표현을 수정한 건수(건)', '수시/주 1회', '수정 전후 표현 예시'), kpi('내부 확인 완료율: 확인 요청 후 답변 기준이 정리된 비율(%)', '2주 1회', '확인 요청 완료 기록')], initiatives: ['허용 표현/금지 표현 예시 공유', '내부 확인 질문 분류', '위험 표현 수정 메모 작성'] },
      { id: 'commercial-signal', type: '사업화 신호 보완형', task: '신약·바이오 성장 스토리에 대한 고객 반응을 수집해 사업화 연결 가능성을 현장 관점에서 보완한다.', csfs: ['고객 수요 신호 수집: 고객 관심과 필요가 확인되어야 한다', '사업화 연결 질문 정리: 제품화 가능성과 관련된 질문이 남아야 한다', '현장 관점 피드백 전달: 고객 반응이 사업화 검토에 전달되어야 한다'], kpis: [kpi('사업화 관련 고객 질문 건수: 사업화·적응증·활용 가능성 관련 질문 수(건)', '2주 1회', '사업화 관련 질문 기록'), kpi('고객 수요 신호 기록 건수: 현장에서 확인된 수요 신호 건수(건)', '2주 1회', '고객 수요 신호 메모'), kpi('사업화 검토 전달 건수: 내부 검토로 전달된 고객 반응 건수(건)', '월 1회', '내부 전달 항목 목록')], initiatives: ['사업화 관련 질문 기록 기준 정리', '고객 수요 신호 메모 작성', '내부 검토 전달 항목 정리'] },
    ],
  },
  {
    ...
    teamTasks: [
      { id: 'execution-management', type: '실행관리 표준화형', task: '고객 반응, 다음 행동, Follow-up 상태를 같은 기준으로 남겨 팀 실행관리와 의사결정에 활용한다.', csfs: ['기록 기준 통일: 고객 반응과 다음 행동을 남기는 기준이 같아야 한다', '후속 상태 가시화: 자료 제공과 Follow-up 상태가 팀장에게 보이도록 관리되어야 한다', '지연 신호 조기 확인: 늦어진 일과 막힌 일을 정기적으로 확인해야 한다'], kpis: [kpi('고객 반응 기록률: 고객 반응이 포함된 방문 기록 비율(%)', '주 1회', '고객 반응이 포함된 방문 기록'), kpi('다음 행동 입력률: 다음 행동이 입력된 방문 기록 비율(%)', '주 1회', '다음 행동이 입력된 기록'), kpi('Follow-up 기한 준수율: 예정일 안에 완료된 Follow-up 비율(%)', '주 1회', 'Follow-up 예정일·완료일 기록')], initiatives: ['고객 반응·다음 행동 기록 기준 정리', 'Follow-up 예정일과 완료 상태 입력', '2주 단위 실행 대시보드 점검'] },
      { id: 'data-standard', type: '고객 데이터 표준화형', task: '영업 현장의 고객 접점 데이터를 표준화해 전사 고객 인사이트 축적에 기여한다.', csfs: ['입력 항목 통일: 팀원들이 같은 항목으로 데이터를 남겨야 한다', '기록 품질 확보: 단순 방문 사실보다 고객 반응과 다음 행동이 포함되어야 한다', '전사 활용 가능성: 기록이 다른 부서에서도 이해 가능해야 한다'], kpis: [kpi('표준 항목 입력률: 정해진 항목이 채워진 고객 기록 비율(%)', '주 1회', '표준 입력 항목 충족 여부'), kpi('기록 품질 충족률: 고객 반응과 다음 행동이 함께 포함된 기록 비율(%)', '주 1회', '좋은 기록/부족한 기록 샘플'), kpi('전사 공유 가능 기록 건수: 다른 부서와 공유 가능한 인사이트 기록 수(건)', '2주 1회', '공유 가능 인사이트 표시')], initiatives: ['표준 입력 항목 재정리', '좋은 기록/부족한 기록 예시 비교', '전사 공유 가능 인사이트 표시'] },
      { id: 'early-warning', type: '실행 지연 조기감지형', task: '고객 반응과 실행 지연 신호를 조기에 확인해 팀 단위 실행관리 품질을 높인다.', csfs: ['지연 기준 명확화: 무엇을 실행 지연으로 볼지 정해져 있어야 한다', '지원 필요 신호 포착: 팀장 지원이 필요한 이슈가 올라와야 한다', '중간 점검 루틴: 주간 점검에서 지연 신호를 확인해야 한다'], kpis: [kpi('실행 지연 건수: 예정일을 넘긴 고객 후속 과제 건수(건)', '주 1회', '지연 과제와 지연 사유 목록'), kpi('지원 필요 등록 건수: 팀장 지원이 필요한 이슈 건수(건)', '주 1회', '지원 필요 이슈 등록'), kpi('지연 해소율: 확인된 지연 과제 중 해소된 비율(%)', '2주 1회', '지연 해소 완료 기록')], initiatives: ['지연 과제 주간 확인', '지원 필요 이슈 등록 기준 정리', '지연 해소 상태 점검'] },
      { id: 'insight-link', type: '전략 인사이트 연결형', task: '방문 기록을 단순 활동 기록이 아니라 다음 행동과 전략 인사이트로 연결한다.', csfs: ['인사이트 전환 기준: 고객 반응이 전략 인사이트로 바뀌는 기준이 있어야 한다', '다음 행동 연결: 기록마다 다음 행동이 붙어야 한다', '반복 신호 요약: 반복되는 고객 반응이 팀 차원에서 요약되어야 한다'], kpis: [kpi('전략 인사이트 전환 건수: 고객 반응이 전략 인사이트로 정리된 건수(건)', '2주 1회', '고객 반응→인사이트 전환 메모'), kpi('다음 행동 연결률: 다음 행동이 포함된 고객 기록 비율(%)', '주 1회', '다음 행동 연결 문장'), kpi('반복 신호 요약 건수: 팀 차원에서 요약된 반복 신호 수(건)', '2주 1회', '반복 신호 요약표')], initiatives: ['고객 반응을 인사이트로 바꾸는 기준 정리', '기록 후 다음 행동 연결 문장 추가', '반복 신호 주간 요약'] },
    ],
  },
  {
    ...
    teamTasks: [
      { id: 'fact-record', type: '문의 사실 기록형', task: '품질·공급·컴플라이언스 관련 고객 문의를 사실 중심으로 기록하고, 확인 전 단정 답변을 줄인다.', csfs: ['문의 사실 기록: 고객 문의를 해석하지 않고 사실 중심으로 남겨야 한다', '확인 전 답변 제한: 내부 확인이 필요한 내용은 즉시 단정하지 않아야 한다', '위험 표현 점검: 고객에게 불안이나 오해를 줄 표현을 사전에 걸러야 한다'], kpis: [kpi('품질·공급 문의 기록 건수: 품질·공급 관련 고객 문의 기록 건수(건)', '주 1회', '품질·공급 문의 기록'), kpi('미확인 답변 발생 건수: 내부 확인 전 단정 답변으로 기록된 건수(건)', '주 1회', '미확인 답변 사례'), kpi('위험 표현 수정 건수: 고객 커뮤니케이션에서 수정한 위험 표현 건수(건)', '수시/주 1회', '수정 전후 표현 예시')], initiatives: ['품질·공급 문의 기록 기준 통일', '내부 확인 필요 질문 분류', '위험 표현 예시 공유'] },
      { id: 'trust-risk', type: '신뢰 리스크 관리형', task: '품질·공급 문의를 내부 확인 흐름과 연결해 고객 신뢰 리스크를 조기에 관리한다.', csfs: ['내부 연결 흐름 확보: 문의가 담당 부서로 빠르게 연결되어야 한다', '처리 기한 명확화: 후속 완료 기준과 기한이 있어야 한다', '고객 불안 완화: 사실 확인 전 불안을 키우지 않아야 한다'], kpis: [kpi('고객 문의 후속 완료율: 정해진 기한 안에 완료된 문의 후속 처리 비율(%)', '주 1회', '문의 후속 완료 상태'), kpi('내부 확인 리드타임: 문의 등록부터 내부 확인 완료까지 평균 일수(일)', '2주 1회', '등록일·확인완료일 기록'), kpi('고객 신뢰 리스크 등록 건수: 신뢰 저하 가능성이 있는 문의 건수(건)', '주 1회', '신뢰 리스크 문의 목록')], initiatives: ['내부 확인 연결 담당 정리', '문의 후속 처리 완료 상태 점검', '고객 신뢰 리스크 신호 공유'] },
      { id: 'safe-expression', type: '안전 표현 정착형', task: '고객 커뮤니케이션에서 위험 표현을 줄이고 승인된 표현 기준을 팀 단위로 정착시킨다.', csfs: ['위험 표현 인식: 과장, 단정, 허가 외 표현을 구분해야 한다', '승인 표현 활용: 승인된 표현을 기준으로 말해야 한다', '수정 피드백 루틴: 위험 표현이 발견되면 즉시 수정되어야 한다'], kpis: [kpi('위험 표현 수정 건수: 고객 커뮤니케이션에서 수정한 위험 표현 건수(건)', '수시/주 1회', '수정 전후 표현 예시'), kpi('승인 표현 사용률: 승인 표현 기준에 맞게 작성된 고객 메시지 비율(%)', '2주 1회', '승인 표현 기준 체크'), kpi('표현 피드백 반영률: 수정 피드백이 반영된 메시지 비율(%)', '2주 1회', '피드백 반영 전후 문장')], initiatives: ['위험 표현 예시 카드 만들기', '승인 표현 문장 공유', '고객 메시지 샘플 점검'] },
      { id: 'repeat-issue', type: '반복 문의 개선형', task: '반복되는 고객 문의 유형을 수집해 전사 품질·공급·컴플라이언스 대응 기준 개선에 기여한다.', csfs: ['반복 문의 유형화: 반복되는 문의가 유형별로 정리되어야 한다', '개선 필요 항목 전달: 반복 문의가 전사 대응 기준 개선으로 연결되어야 한다', '재발 방지 관점 확보: 같은 문의가 반복되는 이유를 확인해야 한다'], kpis: [kpi('반복 문의 유형 분류 건수: 유형화된 반복 문의 건수(건)', '2주 1회', '반복 문의 유형표'), kpi('전사 개선 요청 건수: 대응 기준 개선을 위해 전달한 요청 수(건)', '월 1회', '전사 개선 요청 항목'), kpi('재발 문의 감소율: 동일 유형 문의가 감소한 비율(%)', '월 1회', '동일 유형 문의 추이')], initiatives: ['반복 문의 유형표 작성', '전사 개선 요청 항목 정리', '동일 유형 재발 여부 점검'] },
    ],
  },
];
...
function kpiOf(option: TeamTaskOption, label: string) {
  return option.kpis.find((item) => item.label === label) ?? option.kpis[0];
}
...
export function V41PerformanceCompactCascadeLab() {
  ...
  const selectedKpi = kpiOf(selectedTeamOption, state.selectedKpi);
  ...
  const makeDraft = () => {
    ...
    update({
      ...
      twoWeekFirstAction: `1주차: 담당자별로 '${initiative}' 실행 기준을 맞추고 첫 기록을 남긴다.\n2주차: '${selectedKpi.label}' 기준으로 결과를 모아 지연·지원 필요를 확인한다.\n담당: ${selectedKpi.owner}\n증거: ${selectedKpi.evidence}`,
      pauseActivity: '전사 전략과제와 직접 연결되지 않는 방문 수 늘리기, 장문 보고, 목적 없는 자료 전달은 잠시 줄인다.',
      midCheckQuestion: `이번 주 실행에서 '${csf}'가 보이는 증거는 무엇인가요? '${selectedKpi.evidence}'로 확인하면 어느 담당자 또는 고객군에서 보완이 필요한가요?`,
      finalExecutionStandard: `다음 단계에서는 '${initiative}'를 팀원이 실행할 업무지시로 바꾸고, '${selectedKpi.label}'의 관리 주기(${selectedKpi.cycle})와 확인 증거(${selectedKpi.evidence})를 포함한다.`,
    });
  };
    ...
    <section className="space-y-4">
      ...
      <section className="rounded-3xl border border-cyan-100 bg-cyan-50 p-4 text-sm font-bold leading-6 text-cyan-950 shadow-sm md:p-5">
        ...
        <div className="mt-4 grid gap-3 md:grid-cols-3">
          ...
          <div className="rounded-2xl bg-white p-3"><p className="font-black text-cyan-900">전사 CSF</p><ul className="mt-2 space-y-1 text-xs">{enterpriseTopic.csfs.map((csf) => <li key={csf}>- {csf}</li>)}</ul></div>
          <div className="rounded-2xl bg-white p-3"><p className="font-black text-cyan-900">전사 KPI</p><ul className="mt-2 space-y-1 text-xs">{enterpriseTopic.kpis.map((k) => <li key={k}>- {k}</li>)}</ul></div>
        </div>
      </section>

      <section className="grid gap-3 md:grid-cols-2">
        <Field label="팀 전략과제 보기 4개" help="전사 추진과제와 전사 KPI에 기여할 수 있는 팀 역할을 고릅니다. 선택에 따라 팀 CSF, 팀 KPI, 세부 추진과제가 달라집니다.">
      ...
      <section className="rounded-3xl border border-slate-200 bg-white p-4 shadow-sm md:p-5">
        ...
        <div className="mt-4 grid gap-3 md:grid-cols-2">
          <Field label="팀 CSF" help="선택한 팀 전략과제가 성공하려면 반드시 갖춰져야 할 조건입니다."><div className="space-y-2">{selectedTeamOption.csfs.map((csf) => <label key={csf} className="flex gap-2 rounded-xl bg-white p-2 text-sm font-bold"><input type="radio" checked={(state.selectedCsf || selectedTeamOption.csfs[0]) === csf} onChange={() => update({ selectedCsf: csf })} />{csf}</label>)}</div></Field>
          <Field label="팀 KPI" help="팀장이 주간·2주 단위로 볼 실행 지표입니다. 각 KPI에는 관리 주기와 확인 기준이 붙습니다.">
            <div className="space-y-2">{selectedTeamOption.kpis.map((item) => <label key={item.label} className="flex gap-2 rounded-xl bg-white p-2 text-sm font-bold"><input type="radio" checked={selectedKpi.label === item.label} onChange={() => update({ selectedKpi: item.label })} /><span>{item.label}<span className="mt-1 block text-xs text-slate-500">관리 주기: {item.cycle} · 확인 기준: {item.evidence}</span></span></label>)}</div>
          </Field>
        </div>
      </section>
      ...
      <section className="rounded-3xl border border-slate-200 bg-white p-4 shadow-sm md:p-5">
        ...
        <Field label="세부 추진과제" help="선택한 팀 전략과제를 실제로 시작하기 위한 추진과제를 고릅니다."><div className="space-y-2">{selectedTeamOption.initiatives.map((initiative) => <label key={initiative} className="flex gap-2 rounded-xl bg-white p-2 text-sm font-bold"><input type="radio" checked={(state.selectedInitiative || selectedTeamOption.initiatives[0]) === initiative} onChange={() => update({ selectedInitiative: initiative })} />{initiative}</label>)}</div></Field>
        ...
        <button type="button" className="mt-4 rounded-xl bg-emerald-700 px-4 py-2 text-sm font-black text-white" onClick={makeDraft}>주차별 2주 실행계획 만들기</button>
      </section>
