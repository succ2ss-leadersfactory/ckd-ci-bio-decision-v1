...
const DEFAULT_CARD_ITEMS = [
  ...
  },
  {
    id: 'memberRoles',
    label: '팀원별 역할',
    placeholder: '예: 신재영 대리는 후속 대화 연결, 이대은 대리는 관계 유지 품질 관리, 박재욱 사원은 CRM·정보 보완',
  },
  {
    id: 'twoWeekAction',
    label: '2주 실행 우선순위',
...
export function V38FinalCallPlanCard() {
  ...
  const applyTemplate = () => {
    setCard({
      ...
      memberRoles: '신재영 대리는 후속 대화 연결, 이대은 대리는 관계 유지 품질 관리, 박재욱 사원은 CRM·정보 보완, 유희관 과장은 변화 신호 관찰, 김문호 차장은 접근 강도 조절, 김재호 차장은 현장 대응 후 기록 정리를 맡는다.',
