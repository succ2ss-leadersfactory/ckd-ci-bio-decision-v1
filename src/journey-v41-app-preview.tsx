...
const MEMBERS: Member[] = [
  ...
  { name: '박재욱', title: '사원', career: '입사 1년차 · 기본 방문 루틴을 익히는 단계', role: '기본 활동량과 고객 응대 방식을 배우고 있는 신입 구성원', workStyle: '성실하게 움직이고 지시받은 내용은 잘 수행합니다. 아직 방문 목적을 스스로 선명하게 세우는 데는 연습이 필요합니다.', communicationStyle: '먼저 의견을 내기보다 확인받고 움직이는 편입니다. 피드백을 받으면 빠르게 고치려는 태도가 있습니다.', strength: '성실함, 학습 태도, 기본기를 받아들이는 속도가 좋습니다.', weakness: '고객 반응을 해석하거나 다음 행동을 스스로 정하는 힘은 아직 약합니다.', note: '구체적인 예시와 짧은 기준을 주면 빠르게 안정될 가능성이 있습니다.' },
  { name: '문교원', title: '사원', career: '입사 2년차 · 로컬 고객과의 관계 형성 경험 축적 중', role: '관계 형성이 중요한 고객을 부드럽게 관리하는 구성원', workStyle: '고객과의 분위기를 좋게 만들고 꾸준히 접점을 유지합니다. 다만 좋은 분위기를 업무 대화로 전환하는 데는 연습이 필요합니다.', communicationStyle: '상대 반응을 살피며 조심스럽게 말합니다. 갈등이나 부담스러운 이야기는 피하려는 경향이 있습니다.', strength: '친화력, 고객 접근성, 부드러운 관계 형성 능력이 있습니다.', weakness: '고객에게 필요한 질문을 끝까지 던지지 못하고 대화를 마무리할 때가 있습니다.', note: '관계 강점을 인정하면서 방문 말미에 꼭 확인할 질문 하나를 정해주면 좋습니다.' }
];
